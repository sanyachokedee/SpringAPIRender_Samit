...
class SecurityConfig(
    ...
    fun securityFilterChain(http: HttpSecurity): SecurityFilterChain {
        http
            ...
            .authorizeHttpRequests { auth ->
                auth
                    .requestMatchers("/", "index.html", "/v3/api-docs/**", "/swagger-ui/**", "/swagger-ui.html","/css/**", "/images/**","/uploads/**", "/error").permitAll()
            ...
            // .addFilterBefore(MultipartFilter(), UsernamePasswordAuthenticationFilter::class.java)
    ...
    fun corsConfigurationSource(): UrlBasedCorsConfigurationSource {
        ...
        config.addAllowedOrigin("https://nuxtapprender-7fwb.onrender.com")
